...
function iceBrickVolume(radius, bottleLength, rimLength) {
    // Calculate the length and width of the ice brick
     var brickLength = radius * 2;
     var brickWidth = radius * 2;
     
     // Calculate the height of the ice brick
     var brickHeight = bottleLength - rimLength;
     
     // Calculate the volume of the ice brick
     var brickVolume = brickLength * brickWidth * brickHeight;
     
     return brickVolume / 2;
   }